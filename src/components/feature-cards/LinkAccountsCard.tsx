...
const recipients = [
  { name: "ООО «Альфа Групп»", info: "Сочи, 12 чел., 5 дней", code: "T-10112", image: "/professional-man-portrait.png" },
  { name: "АО «РосТех»", info: "Казань, 8 чел., 3 дня", code: "T-10132", image: "/professional-woman-portrait.png" },
  { name: "ГК «Меридиан»", info: "Байкал, 20 чел., 7 дней", code: "T-10184", initials: "ГМ", color: "bg-teal-600" },
  { name: "ИП Фролов А.С.", info: "Алтай, 4 чел., 4 дня", code: "T-10114", initials: "ИФ", color: "bg-amber-600" },
]
...
export function LinkAccountsCard() {
  return (
    <div className="rounded-2xl bg-[#141414] border border-[#262626] p-6 flex flex-col">
      ...
      <h3 className="mb-2 text-lg font-semibold text-white">Заявки от компаний</h3>
      <p className="mb-4 text-sm text-gray-400">Компании оставляют запрос — направление, даты, количество человек. Вы сразу видите все детали и беретесь за поиск</p>
